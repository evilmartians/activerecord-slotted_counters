...
ActiveRecord::Schema[7.0].define(version: 2022_08_24_125118) do
  ...
  create_table "with_native_counter_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["with_native_counter_article_id"], name: "article_id"
  end
  ...
  create_table "with_slotted_counter_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["with_slotted_counter_article_id"], name: "slotted_counter_article_id"
  end
